                  ...
                  <div class="col-md-12">
                    <div class="card card-plain">                      
                        ...
                        <div class="row justify-content-center mt-5">
                            <label class="textP">Resultado obtenido</label> 
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="reportTable">
                                        ...
                                        <tbody>
                                            <tr>
                                <%	
                                        String nameGames = (String) sesion.getAttribute("resulQ3"); 
                                        ManagerControl manager = ManagerControl.getInstante();
                                        List<Juego> listJuego = manager.getCjue().traerJuego();        
                                        Juego jue = null;
                                        for(Juego elem : listJuego){
                                            if(elem.getNombre().equals(nameGames)){
                                                jue = elem;
                                                break;
                                            }
                                        }                                        
                                        for(Empleado e : jue.getListaEmpleado()){                                        
                                %>
