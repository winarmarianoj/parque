            ...
            <div class="content">
              <div class="container-fluid">
                <div class="row">
                  ...
                  <!--INICIO DE BOTONES -->
                  <a href="ListGames.jsp" type="button" class="btn btn-outline-primary">Lista de Juegos</a>
                  <a href="ListHours.jsp" type="button" class="btn btn-outline-secondary">Lista de Horarios</a>
