        ...
        <section class="welcome">
            ...
            <!--INICIA WELCOM-->
                <div class="row d-flex justify-content-center align-items-center pb-4 ">
                    <img src="img/logos.png" width="20%" alt="">
                    <p class="titleWelcome text-white">Welcome System</p>
                </div>

                <div class="row d-flex justify-content-center align-items-center pb-4 ">
                    <a href="Login.jsp" type="button" class="btn btn-success">Ingresar al Sistema</a>
                    <a href="Register.jsp" type="button" class="btn btn-warning">Registrarse en el Sistema</a>
                </div>
