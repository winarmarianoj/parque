<%-- 
    ...
    Created on : 15 dic. 2020, 19:14:10
    Author     : mariano
--%>
                      ...
                      <div class="col-md-12">
                        <div class="card card-plain">
                            ...
                            <div class=""> <!--card-header card-header-primary-->
                              <h4 class="card-category mt-0"><b>Ingrese el Id del Empleado que desee Modificar o Eliminar</b></h4>
                              <p class="card-category"><b>Sólo presione el Botón sobre la opción que este necesitando.</b></p>
                              <div class="col">                          
                                  <label id="labels">Id de Empleado</label>
                                  <input type="text"  id="idEmployee" placeholder="" value="" required>
                        ...
                        <!--INICIO DE BOTONES -->
                        <button id="changeEmployee" type="button" class="btn btn-primary">Cambiar Datos</button>
                        <button id="deleteEmployee" type="button" class="btn btn-secondary">Eliminar Empleado</button>
                        <!--FIN DE BOTONES -->                        
                      </div>
                  </section>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="ChangeEmpleadoServlet" method="POST">                                          
                                          <div class="row my-4">
                                            ...
                                            <!--INICIO DE BOTONES-->
                                           <input type="button" name="Supervisar: Primer Paso" id="btnRegister" value="Registrarse" " class="btn btn-warning" onclick="formChangeProfile(btnChangeProfile)" />  
