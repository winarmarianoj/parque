<%-- 
    Document   : changeUser
    Created on : 15 dic. 2020, 19:19:14
    Author     : mariano
--%>
                      ...
                      <div class="col-md-12">
                        <div class="card card-plain">
                            ...
                            <div class=""> <!--card-header card-header-primary-->
                              <h4 class="card-category mt-0"><b>Ingrese el Id del Usuario que desee Modificar o Eliminar</b></h4>
                              <p class="card-category"><b>Sólo presione el Botón sobre la opción que este necesitando.</b></p>
                              <div class="col">                          
                                  <label id="labels">Id de Usuario</label>
                                  <input type="text"  id="idUser" placeholder="" value="" required>
                                  <p class="card-category my-2"><b>En el caso que no lo recuerde, busque su Id en Listados de Empleados.</b></p>                        
                              </div>
                            </div>
                        ...
                        <!--INICIO DE BOTONES -->
                        <button id="changeUser" type="button" class="btn btn-primary">Cambiar Datos</button>
                        <button id="deleteUser" type="button" class="btn btn-secondary">Eliminar Usuario</button>
                        <!--FIN DE BOTONES -->                        
                      </div>
                  </section>
                                          ...
                                          <div class="row my-4">
                                            ...
                                            <div class="col-md-6">
                                              <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="changeNameUser" id="nombreUsuario">
                                              </div>
                                              <div class="form-group">
                                                <label class="bmd-label-floating">Su Password</label>
                                                <input type="text" class="form-control" name="changePassword" id="nombreUsuario">
                                              </div>
                                            </div>                            
                                          </div>                                          
                                          <input type="button" name="Supervisar: Primer Paso" id="btnRegister" value="Registrarse" " class="btn btn-warning"  onclick="formChangeUser(btnChangeUser)"/>  
