...
<head>
  ...
  <title> Game Park - Ingreso de Juegos y Horarios nuevos </title>
</head>
                  ...
                  <div class="col-md-8">
                    <div class="card">
                      <div class="card-header card-header-primary">
                        <h4 class="card-title">Ingrese Horarios y Juegos nuevos</h4>
                        <p class="card-category">Recuerde que puede listar los juegos y horarios ya existentes</p>
                      </div>
                      <div class="card-body">
                          ...
                          <div class="row my-5">
                            <div class="col-md-5">
                              <div class="form-group">
                                <label class="bmd-label-floating">Sólo la Hora en formato 24 hs.</label>
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-group">
